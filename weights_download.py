...
hf_hub_download(repo_id="pscotti/mindeyev2",filename="bigG_to_L_epoch8.pth",repo_type="dataset",cache_dir='./weights')
...
# Animate Diffusion
hf_hub_download(repo_id="guoyww/animatediff",filename="v3_sd15_adapter.ckpt",cache_dir='./weights')
